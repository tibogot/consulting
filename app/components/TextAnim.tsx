...
const TextAnim = ({ 
  ...
  useEffect(()=>{
    ...
    const ctx = gsap.context(()=>{
      ...
      splitRef.current = new SplitText(currentElement, { type: "chars, words"})
      ...
      const resetAnimation = ()=>{
        ...
        if (!currentElement || !currentElement.isConnected || !splitRef.current || !splitRef.current.chars) return;
