...
export default function CssGradientTailwind() {
  ...
  const gradientColors = useControls("🎨 Gradient Colors", {
    color1: { value: "#8202FF", label: "Color 1" },
    color1Alpha: {
      value: 0.8,
      min: 0,
      max: 1,
    ...
    color2: { value: "#5a02b3", label: "Color 2" },
    color2Alpha: {
      value: 0.4,
      min: 0,
      max: 1,
    ...
    color3: { value: "#1a0033", label: "Color 3" },
    color3Alpha: {
      value: 0.15,
      min: 0,
      max: 1,
    ...
    color4: { value: "#000000", label: "Color 4" },
    color4Alpha: {
      value: 0.05,
      min: 0,
      max: 1,
  ...
  const color1Rgba = hexToRgba(
    gradientColors.color1,
    gradientColors.color1Alpha
  );
  const color2Rgba = hexToRgba(
    gradientColors.color2,
    gradientColors.color2Alpha
  );
  const color3Rgba = hexToRgba(
    gradientColors.color3,
    gradientColors.color3Alpha
  );
  const color4Rgba = hexToRgba(
    gradientColors.color4,
    gradientColors.color4Alpha
  );
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='${(
            0.9 / noiseOverlay.scale
          ).toFixed(
            2
