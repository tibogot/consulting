...
const StickyCards3D = () => {
  ...
  return (
    <div
      className="bg-black relative h-full w-full overflow-hidden"
      style={{ isolation: "isolate" }}
      ref={container}
    >
      {stickyCardsData.map((cardData, index) => (
        <div
          className="sticky-card-3d relative flex h-screen w-full items-center justify-center overflow-hidden will-change-transform"
          style={
            {
