...
export default function Footer() {
  ...
  return (
    ...
    >
      <div className="relative lg:-top-[100vh] lg:h-[200vh]">
        <div className="lg:sticky lg:top-0 lg:h-screen">
          <footer className="relative z-10 mt-auto bg-black text-white lg:flex lg:h-full lg:flex-col">
            <div className="w-full px-4 py-12 sm:px-6 lg:flex lg:flex-1 lg:flex-col lg:justify-between lg:gap-10 lg:px-8">
              <div className="grid grid-cols-2 gap-8 md:grid-cols-2 lg:mt-40 lg:grid-cols-7">
                {/* Logo & Description */}
            ...
            <div className="w-full px-4 md:px-8 lg:mt-auto">
              <img
