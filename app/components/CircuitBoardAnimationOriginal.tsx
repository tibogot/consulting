  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      pulses.forEach((pulse) => {
        ...
        if (result) {
          context.globalAlpha = result.opacity * 0.4;
          drawPath(
            result.points,
            "#4466aa",
  ...
  return (
    ...
    >
      ...
      <img
        src={logoSrc}
        alt="Logo"
        className="pointer-events-none absolute top-1/2 left-1/2 z-10 h-auto w-[clamp(100px,18vw,200px)] -translate-x-1/2 -translate-y-1/2"
      />
    </div>
  );
}
