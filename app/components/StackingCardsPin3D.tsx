...
export default function StackingCardsPin3D({ className = "" }: { className?: string }) {
  ...
  const cards = useMemo<StackingCard[]>(
    () => [
      ...
      },
      {
        ...
        imageSrc: "/images/cards/zac-wolff.jpg",
      },
    ],
    []
  );
  ...
  useGSAP(
    () => {
      ...
      const cardEls = gsap.utils.toArray<HTMLElement>("[data-stacking-card-3d]");
  ...
  return (
    <section ref={sectionRef} className={`relative w-full bg-black ${className}`} style={{ isolation: "isolate" }}>
        ...
        <div className=" px-4 md:px-8">
          <div className="font-pp-neue-montreal max-w-3xl mb-14">
            ...
            <p className="mt-4 text-white/70 text-base md:text-lg">
              Section pins, cards stack with 3D rotation effects, then unpins to next section.
            </p>
            </AnimatedCopy>
          </div>
            ...
            <div className="w-[92%] md:w-[70%]">
              {cards.map((card, index) => (
                <article
                  ...
                  className="relative w-full overflow-hidden rounded-sm border border-white/10 bg-white/5 mb-12 will-change-transform"
                  style={{
                    height: '600px',
                    "--after-opacity": 0,
                ...
                >
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-between p-6 md:p-10 z-3">
